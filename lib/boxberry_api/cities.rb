  ...
  class Cities
    ...
    CODES = {
      ...
      '18-0-4-0' => {
        ...
        city:     141,
        address:  "г. Глазов, ул. Первомайская, д. 1, каб. 7",
        delivery: 16, # 8
        phone:    "+7 (34141) 2-23-02",
        work:     "пн.-пт. с 9:00 до 18:00"
      ...
      '42-0-9-0' => {
        ...
        work:     "пн.–пт. с 8:00 до 20:00, сб. с 9:00 до 16:00"
      ...
      '51-0-1-0' => {
        ...
        city:     69,
        address:  "г. Мурманск, ул. Володарского, д. 14а",
        delivery: 15, # 7
      ...
      '54-0-1-0' => {
        ...
        work:     "пн-пт с 8:00 до 19:30, сб с 10:00 до 15:00"
      ...
      '56-0-4-0' => {
        ...
        city:     0,
        address:  "г.Орск, пер. Янки Купалы, д. 8а",
        delivery: 25, # 11
        phone:    "+7 (3537) 22-10-49",
        work:     "пн.–пт. с 9:00 до 18:00"
      ...
      '78-0-0-0' => {
        ...
        city:     116,
        address:  "г. Санкт-Петербург, пр-т Юрия Гагарина, д. 2, 1 этаж, офис Боксберри",
        delivery: 11, # 3
        phone:    "+7 (812) 378-66-44, 378-69-43",
        work:     "пн-пт. с 10:00 по 19:00, сб. c 11:00 по 16:00"
      ...
      '13-0-1-0' => {
        ...
        city:     117,
        address:  "г. Саранск, Ленинский район, ул. Терешковой, д. 16, пом. 1",
        delivery: 18, # 10
      ...
      '76-0-1-0' => {
        ...
        delivery: 11, # 3
        phone:    "+7 (4852) 92-66-42, 8 (902) 332-66-42",
        work:     "пн.-пт. с 09:00 до 19:00, сб. с 10:00 до 14:00"

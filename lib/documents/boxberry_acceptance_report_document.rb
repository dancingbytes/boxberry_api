  ...
  module AcceptanceReport
    ...
    class Document
      ...
      def initialize(datas)
        ...
        # Переменные
        @snippets   = ::Boxberry::AcceptanceReport::Snippets.new(datas)
      ...
      def save
        ...
        file = ::File.join(File.dirname(__FILE__), "templates", "boxberry_acceptance_report_document.html")
        ...
        begin
          ...
          ::Rails.logger.tagged("BoxberryAcceptanceReportDocument") {
    ...
    class Base
      ...
      def save
        ...
        @doc = ::Boxberry::AcceptanceReport::Document.new(self)
        @doc.save
      ...
      def set_defaults_if_empty
        ...
        ::Boxberry::AcceptanceReport::Base::DEFAULTS.each do |name, value|
